...
/**
 * CLI runner that manages the command-line interface loop.
 * This class handles user input, processes commands, and displays
 * the interactive menu for the music band collection application.
 */
public class CliRunner {
    /**
     * Starts the interactive CLI application.
     * This method initializes the invoker, loads the collection, and enters
     * a continuous loop to process user commands until the application exits.
     */
