...
/**
 * Command implementation for adding a new music band to the collection.
 * This command prompts the user for all required fields and adds the new element
 * to the collection's heap data structure.
 */
public class AddElementCommand implements Command{
    ...
    /**
     * Executes the command to add a new music band to the collection.
     * Prompts the user for all required fields including name, number of participants,
     * genre, coordinates, description, and best album information.
     */
    @Override
    public void execute(){
