...
/**
 * Manager class responsible for parsing and routing user commands to the
 * appropriate invoker methods.
 * This class handles command validation, argument parsing, and delegation to
 * the Invoker for execution.
 */
public class CommandManager {
  ...
  private static boolean validateCommand(String command) {
    ...
    String[] validCommands = { "show", "add", "info", "history", "exit", "help", "clear", "remove_by_id", "update",
        "remove_greater", "execute_script", "add_if_min", "average_of_number_of_participants",
        "count_by_number_of_participants", "save", "remove_any_by_best_album" };
