...
public class Invoker {
  ...
  private ListEverythingCommand listEverythingCommand = new ListEverythingCommand();
  /** Command to exit the application */
  private ExitCommand exitCommand = new ExitCommand();
  /** Command to display collection information */
  private ListInfoCommand listInfoCommand = new ListInfoCommand();
  /** Command to add a new element */
  private AddElementCommand addElementCommand = new AddElementCommand();
  /** Command to add element if it's minimum */
  private AddIfMinCommand addIfMinCommand = new AddIfMinCommand();
  /** Command to calculate average participants */
  private AverageParticipantsCommand averageParticipantsCommand = new AverageParticipantsCommand();
  /** Command to show command history */
  private ShowHistoryCommand printHistoryCommand = new ShowHistoryCommand();
  /** Command to display help */
  private HelpCommand helpCommand = new HelpCommand();
  /** Command to clear the collection */
  private CleanHeapCommand cleanHeapCommand = new CleanHeapCommand();
  ...
  private RemoveByBestAlbumCommand removeByBestAlbumCommand = new RemoveByBestAlbumCommand();
  /** Command to remove elements greater than ID */
  private RemoveGreaterThanIdCommand removeGreaterThanIdCommand = new RemoveGreaterThanIdCommand();
  /** Command to update element */
  private UpdateElementCommand updateElementCommand = new UpdateElementCommand();
  ...
  /**
   * Removes all music bands from the collection that have an ID greater than the
   * specified value.
   *
   * @param id the ID threshold - all bands with ID greater than this will be
   *           removed
   */
  ...
  /**
   * Displays information about the collection including type, initialization
   * date, and element count.
   */
  ...
  /**
   * Adds a new element to the collection by prompting the user for all field
   * values.
   */
  ...
  /**
   * Adds a new element to the collection only if its ID is less than the minimum
